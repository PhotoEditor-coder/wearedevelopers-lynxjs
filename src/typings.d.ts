...
export interface InputProps
  extends Omit<StandardProps, 'bindfocus' | 'bindblur'> {
  /**
   * Placeholder
   * @Android
   * @iOS
...
export type InputUIMethods =
  | InputFocusMethod
  | InputBlurMethod
  | InputGetValueMethod
  | InputSetValueMethod
  | InputSetSelectionRangeMethod;
...
export interface TextAreaProps
   ...
   */
  bindselection?: (
    e: BaseEvent<'bindselection', TextAreaSelectionChangeEvent>
  ) => void;
...
export type TextAreaUIMethods =
  | TextAreaFocusMethod
  | TextAreaBlurMethod
  | TextAreaGetValueMethod
  | TextAreaSetValueMethod
  | TextAreaSetSelectionRangeMethod;
